...
INSERT INTO `class_head` (`class_id`, `subject_id`, `day`, `time`, `school_year_id`, `term`, `room`) VALUES
...
(1, 'Christopher@Whitted.com'),
(2, 'mark@whitted.com'),
(3, 'Marvin@BethanyBible.com');
...
INSERT INTO `person_email` (`person_email_id`, `person_id`, `email_id`, `email_type`) VALUES
(1, 1, 1, 'Student'),
(2, 1, 2, 'Father'),
(3, 5, 3, 'Teacher');
...
CREATE TABLE `report_card_subject_line` (
  `report_card_head_id` int(10) UNSIGNED NOT NULL,
...
INSERT INTO `student` (`student_id`, `person_id`, `dob`, `grade`, `fed_student_id`) VALUES
(1, 1, '1999-01-16', '12', ''),
(2, 10, '1999-01-15', '12', ''),
(3, 25, '1996-04-26', '9', '');
...
CREATE TABLE `teacher` (
  ...
  `report_card_name` int(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `teacher` (`teacher_id`, `person_id`, `start_date`, `report_card_name`) VALUES
(1, 3, '0000-00-00', 0),
(2, 4, '0000-00-00', 0),
(3, 9, '0000-00-00', 0),
(4, 5, '0000-00-00', 0),
...
ALTER TABLE `person_email`
  ADD PRIMARY KEY (`person_email_id`) USING BTREE;
...
ALTER TABLE `report_card_subject_line`
  ADD PRIMARY KEY (`report_card_head_id`,`report_card_line_id`,`school_year_id`,`day`,`subject_id`) USING BTREE,
  ADD KEY `school_year_num` (`school_year_id`),
  ADD KEY `subject_num` (`subject_id`),
...
--
ALTER TABLE `person_email`
  MODIFY `person_email_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
...
--
-- AUTO_INCREMENT for table `report_card_subject_line`
--
ALTER TABLE `report_card_subject_line`
  MODIFY `report_card_line_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `report_card_subject_line`
  ADD CONSTRAINT `report_card_subject_line_ibfk_1` FOREIGN KEY (`report_card_head_id`) REFERENCES `report_card_head` (`report_card_id`),
